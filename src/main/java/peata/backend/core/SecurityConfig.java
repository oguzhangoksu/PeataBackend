    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        ...
        .cors(cors -> cors.configurationSource(corsConfigurationSource()))
            .authorizeHttpRequests(authorizeRequests ->
                authorizeRequests
                    .requestMatchers("/user/auth/login", "/user/auth/register","/admin/auth/login","/user/getPasswordCode","/user/changePassword","/add/getPaginatedAdds","/user/emailVerification","/user/getEmailVerificationCode").permitAll()
